// File: lib/services/bank_parsers/bidv_parser.dart

import 'bank_notification_parser.dart';

class BIDVParser extends BankNotificationParser {
  @override
  String get bankCode => 'bidv';

  @override
  List<String> get supportedPackages => ['com.bidv.smartbanking', 'bidv'];
