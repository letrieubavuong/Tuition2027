...
class NotificationService {
  ...
  Future<void> scheduleTestNotification(int secondsFromNow) async {
    ...
    final tz.TZDateTime scheduledDateTime = now.add(Duration(seconds: secondsFromNow));
    ...
    final androidDetails = AndroidNotificationDetails(
      ...
      additionalFlags: Int32List.fromList([4]), // FLAG_INSISTENT reo lặp như báo thức
  ...
  Future<void> syncAllClassReminders() async {
    try {
      ...
      final List<LichHoc> listLich = maps
          .map((map) => LichHoc.fromMap(map))
          .toList();
      ...
      developer.log(
        '✅ Đã đồng bộ thành công ${listLich.length} thông báo ca dạy!',
        name: 'NotificationService',
      );
    } catch (e) {
      developer.log(
